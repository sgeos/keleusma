...
- [TYPE_SYSTEM.md, Text Types](../../docs/spec/TYPE_SYSTEM.md#text-types) is the type-system specification.
...
- [`docs/decisions/BACKLOG.md`, B16](../../docs/decisions/BACKLOG.md) records the architectural rationale for the parametric shape.
...
- `R42` in [`docs/decisions/RESOLVED.md`](../../docs/decisions/RESOLVED.md) is the design rationale.
- [`docs/spec/WIRE_FORMAT.md`](../../docs/spec/WIRE_FORMAT.md) documents the header extension layout.
...
- [`docs/architecture/LANGUAGE_DESIGN.md` § Cost model](../../docs/architecture/LANGUAGE_DESIGN.md#cost-model) explains the `CostModel` contract and the host's role in calibration.
