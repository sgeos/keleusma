...
|---|---|
| `book/src/GETTING_STARTED.md` | Ch 2, Ch 31 |
| `examples/scripts/01`–`11` | Ch 3, 4, 8, 9, 10, 11, 14, 21, 22, 23, 26 |
| `book/src/WHY_REJECTED.md` | Ch 19 |
| `book/src/BIG_NUMBERS.md` | Ch 23 |
| `book/src/PIANO_ROLL.md` | Ch 27–29 |
| `docs/extras/SONG_*_SPEC.md` | Ch 30 |
| `book/src/EMBEDDING.md` | Ch 32–37 |
| `book/src/COOKBOOK.md` | Ch 35, Ch 39 |
| `examples/piano_roll.rs` | Ch 33, 34, 37, 39 |
| `book/src/FAQ.md` | Woven throughout as sidebars |
| `book/src/ROGUE.md` | Ch 40 |
