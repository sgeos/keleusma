...
| branch maximum | `src/verify.rs:1059` | V0.2.X line | already implemented, Theorem A1 with Corollary A1s justifies it under Hypothesis H, discharged as Appendix B item 10 records |
