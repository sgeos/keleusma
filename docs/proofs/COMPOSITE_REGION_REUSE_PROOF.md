# Region Slot Reuse Under Escape Confinement — Theorems and Proofs
...
Everything project-specific is below this line. The mapping is: the machine is the Keleusma
