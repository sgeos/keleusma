...
> Part IX, Embedding Keleusma in a Rust Program. Chapter 38 of 40.
> Previous: [Chapter 37, Hot Code Swap from the Host](./37_hot_swap_host.md).
> Next: [Chapter 39, A Full Host, End to End](./39_full_host.md).
