...
> Part IX, Embedding Keleusma in a Rust Program. Chapter 37 of 40.
> Previous: [Chapter 36, Loading Precompiled and Signed Bytecode](./36_loading_bytecode.md).
> Next: [Chapter 38, Calibrated WCET and Cost Models](./38_cost_models.md).
