...
> Part V, The Verifier and the Guarantees. Chapter 19 of 40.
> Previous: [Chapter 18, The Data Segment](./18_data_segment.md).
> Next: [Chapter 20, Time and Memory Budgets](./20_time_and_memory_budgets.md).
