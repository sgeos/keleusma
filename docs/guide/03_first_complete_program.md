...
> Part I, Setting Out. Chapter 3 of 40.
> Previous: [Chapter 2, Installing Keleusma and the Interactive Prompt](./02_installing_and_running.md).
> Next: [Chapter 4, Values and Types](./04_values_and_types.md).
