...
> Part III, Shaping Data. Chapter 14 of 40.
> Previous: [Chapter 13, Pattern Matching in Depth](./13_pattern_matching.md).
> Next: [Chapter 15, The Three Function Categories](./15_three_function_categories.md).
