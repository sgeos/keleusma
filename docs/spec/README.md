...
| [NATIVE_STRING_ABI.md](./NATIVE_STRING_ABI.md) | The string portion of the native ABI: the borrowed length-delimited view a string-taking host native observes, identically under the virtual-machine and ahead-of-time embeddings |
