...
The remaining B35 work is the phases P6 through P9, namely the discriminant-to-enum conversion, the native error arm, the native code generation contract, and documentation.
