...
## ~~B37. Unsignatured-native text-bearing composite returns disagree on flat-versus-boxed body~~ (Resolved for V0.2.1 via the native-result flatten; snapshot/materialise limitation and the signatured-native direction deferred)
