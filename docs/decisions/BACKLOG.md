...
The remaining B35 work is the phases P5 through P9, namely newtype construction, the discriminant-to-enum conversion, the native error arm, the native code generation contract, and documentation.
