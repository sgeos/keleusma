...
appear, and neither would one that reads source through a helper this scan does not follow. Block
comments are handled by none of these strips, and each says so.
